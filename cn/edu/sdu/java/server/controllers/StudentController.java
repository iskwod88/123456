...
public class StudentController {
    ...
    public DataResponse getStudentCourseList(@Valid @RequestBody DataRequest dataRequest) {
        return studentService.getStudentCourseList(dataRequest);
    }

    @PostMapping("/addCourseToStudent")
    @PreAuthorize("hasRole('ADMIN') or hasRole('STUDENT')")
    public DataResponse addCourseToStudent(@Valid @RequestBody DataRequest studentRequest, @Valid @RequestBody DataRequest courseRequest) {
        return studentService.addCourseToStudent(studentRequest, courseRequest);
    }

    @PostMapping("/studentCourseDelete")
    @PreAuthorize("hasRole('ADMIN')")
    public DataResponse studentCourseDelete(@Valid @RequestBody DataRequest studentRequest, @Valid @RequestBody DataRequest courseRequest) {
        return studentService.studentCourseDelete(studentRequest, courseRequest);
    }
}
